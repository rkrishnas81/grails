...
# =============================
def main() -> None:
    tickers_raw = "FTAI,BIDU,NKE,MSTZ,ANF,VTWO,URA,BAH,GM,LPLA,TRGP,CPAY,VONG,HCA,APO,NBIS,MPC,BOIL,KOLD,NUGT,NXPI,BWXT,KKR,TQQQ,SQQQ,GNRC,SOXL,SSNC,COPX,SIL,XYL,CHTR,BMNR,FNV,LYB,FLUT,CBOE,FN,TSLA,APLD,APTV,EPAM,UDOW,AAOI,BURL,VEEV,WIX,HLT,GOOGL,PAYC,QUAL,ARES,SYF,BABA,W,HUBS,ARKK,KEYS,SHAK,ANET,GWRE,SFM,MTUM,UVXY,MTSI,ENPH,PSX,CG,NOW,FIVE,CDW,PANW,WDAY,FANG,RH,PBF,ABBV,ZTS,IQV,GMED,CELH,YINN,GBTC,PEP,VB,DLTR,AVY,VRSN,AXP,RL,PEGA,HIG,MMC,MMM,SJM,NTRS,NUE,NVO,TPR,SAP,MCO,SCCO,ED,IR,IONS,EOG,ACN,EQT,MRK,IWN,EFX,MSFT,UGL,SATS,RSP,DE,DECK,BK,ECL,VTI,SMTC,SNPS,TRV,SGI,MOH,MKSI,IGM,FISV,FLEX,TRI,ETR,UPRO,AVGO,SIVR,VRSK,H,GDXJ,DG,FTNT,SPXU,ETN,ZBH,INTC,SPG,ORCL,ORLY,TSM,SBUX,SCHW,IBKR,SWKS,DAL,SMH,ALNY,AIG,AMD,AME,AMGN,ENTG,INCY,PPLT,SEDG,GDDY,ETSY,FLNC,RIVN,LUNR,IREN,IOT,CEG,CRDO,GTLB,TSLQ,TSLL,GGLL,NVDL,GEHC,NXT,SMX,CAVA,QBTS,BITX,WRBY,BROS,EXE,SYM,FERG,RBLX,COIN,SOC,RGTI,ONON,PL,HUT,DOCS,OKLO,CNM,DUOL,HOOD,VSCO,MNDY,AFRM,USAR,TKO,TLN,ETH,FETH,BTC,PTIR,MUU,PLTU,TEM,TTAN,SNDK,RKLX,CRWV,QBTX,GLXY,CRCL,ASTX,KRMN,SN,ETHT,ETHU,ARM,CART,KVYO,VLTO,TSLT,ABVX,FBTC,METU,IBIT,ALAB,RDDT,BITU,SBIT,ULS,RBRK,VIK,BITB,IONQ,UPST,ABNB,AA,GDS,LW,VST,OKTA,FND,CVNA,NTNX,SEI,MDB,SE,ZS,DOCU,NVT,GLDM,BJ,ROKU,BE,ELF,TWLO,SHOP,JCI,WING,TRU,NTRA,PYPL,OLLI,PI,LITE,PLNT,PFGC,PSTG,SPMO,RACE,XYZ,TEAM,Z,LQDA,PDD,GH,FOUR,MP,LMND,FROG,SNOW,U,PLTR,HWM,HIMS,QQQM,PRAX,RKLB,GDXU,CIFR,SMR,DASH,ASO,TT,RVMD,VRT,ESTC,CCEP,MRNA,DELL,FUTU,FOXA,TW,ZM,UBER,ETHE,CRWD,BBIO,MIRM,NET,DDOG,ASTS,BILL,FDX,AGQ,WTW,CTSH,MS,EL,PM,EMR,SRE,EXPD,IWP,DUK,FCX,MTB,VO,NEE,VTV,VUG,TTWO,STRL,FDS,NFLX,DTE,IGV,CORT,COO,PWR,TNA,CPT,RMBS,AMZN,SOXX,CTAS,TGT,DHI,DHR,DIS,INSM,DOV,DRI,AMKR,SPXL,IT,GD,CLS,CSGP,RSG,LHX,HSY,HUM,IBM,HD,NTES,IFF,ITT,COHR,LEU,ITW,JBHT,JBL,BIIB,ICLR,WELL,AMT,GE,CYTK,GILD,CBRE,NRG,CRL,GLW,CRM,FFIV,AXTI,XLY,EW,XLI,GPC,XLK,MET,XLV,BG,PKG,ON,COR,FLR,WCN,XPO,MRVL,KTOS,WRB,AAPL,KMX,CCJ,AWK,TECL,CDNS,DGX,ABT,B,EWY,CB,AAON,ZBRA,AON,BRKB,BSX,LMT,LOW,LRCX,LSCC,BR,CAH,NVS,EAT,V,ADBE,ADI,DIA,ADSK,LULU,UPS,MAR,AEM,BX,TEL,DKS,MTN,WYNN,AAP,AVB,BDX,IYW,NLR,CIEN,CVX,CI,CME,NVDA,STX,IWB,ATI,MSTR,ADP,AEP,AFL,AJG,PNFP,ALB,HON,ELV,ALK,ALL,PODD,AMAT,APD,APH,JAZZ,A,ATO,GRMN,J,FIG,JKHY,IRM,EXR,GOOG,TXRH,DLR,HALO,GLD,NDAQ,STLD,DXCM,WPM,EXPE,CF,AMP,ICE,LYV,UAL,BLDR,XBI,DEO,WST,UHS,UNH,UNP,URBN,RTX,WM,PLD,XOM,VLO,VRTX,WAB,WDC,WEC,STZ,WMT,WSM,VMC,TXT,XHB,VIG,CMA,JPM,ROK,ROP,ROST,RPM,YUM,CLX,RIO,COF,BA,LNG,BBY,CRH,TCOM,CRS,RY,USO,SNX,CHD,SLV,ITB,GDX,QLD,XME,XOP,TECK,TMUS,LDOS,CSIQ,OC,FSLR,AER,AVAV,SMCI,PRU,EHC,TXN,TSEM,C,CVS,EBAY,MOD,MSI,TTMI,MU,ONTO,MDT,NBIX,NICE,WFC,NSC,NTAP,ODFL,ALGN,OKE,NEM,OMC,IWM,IWF,KMB,ILMN,AU,LEN,LH,JEF,CCI,IWD,MAA,VTR,MIDD,IVW,MCD,IVE,MCHP,IJR,MTZ,COP,PAAS,AEE,RGLD,RJF,CHRW,SHW,STE,SYK,STT,RGEN,SWK,TER,THC,TJX,TOL,DVA,TRMB,TROW,TECH,RMD,RCL,ACGL,PAYX,PCAR,AKAM,PG,PGR,PHM,IBB,GPN,PTC,PNC,BRO,POOL,NTR,PPG,PSA,LIN,QCOM,JNJ,FLY"
