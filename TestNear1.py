...
def main() -> None:
    ...
    for t in tickers:
        ...
        scan_rows.append({
            ...
            "TC2000_AbsRange": round(
                safe(feats.iloc[i].get("TC2000_AbsRange", np.nan)), 2
            ),
        })
